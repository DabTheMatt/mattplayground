...
function onecolumn_scripts() {
	...
	wp_enqueue_script( 'onecolumn-nav', get_template_directory_uri() . '/js/nav.js' );
...
function onecolumn_theme_customizer( $wp_customize ) {
	$wp_customize->add_section( 'onecolumn_logo_section' , array(
		...
		'priority' => 30,
		'description' => __( 'This logo will replace site title and tagline.', 'onecolumn' ),
	) );
	...
	$wp_customize->add_setting( 'onecolumn_logo_width', array(
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'onecolumn_logo_width', array(
		'label' => __( 'Width', 'onecolumn' ),
		'description' => __( 'Only numeric characters allowed. Leave empty for original size.', 'onecolumn' ),
		'section' => 'onecolumn_logo_section',
		'type' => 'number',
		'settings' => 'onecolumn_logo_width',
		'input_attrs' => array(
			'min' => 20,
			'max' => 1200,
			'step' => 20,
	...
	$wp_customize->add_section( 'onecolumn_footer_section' , array(
		'title' => __( 'Footer', 'onecolumn' ),
		'priority' => 33,
	) );
	$wp_customize->add_setting( 'onecolumn_footer_content', array(
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'wp_kses_post',
	) );
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'onecolumn_footer_content', array(
		'label' => __( 'Content', 'onecolumn' ),
		'type' => 'textarea',
		'section' => 'onecolumn_footer_section',
		'settings' => 'onecolumn_footer_content',
	) ) );
}
